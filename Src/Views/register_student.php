...
<div class="max-w-md w-full bg-white rounded-[2.5rem] p-10 shadow-xl shadow-slate-200 border border-slate-100">
    ...
    <form action="../../Public/process_register.php" method="POST" class="space-y-5">
        ...
        <div>
            <label class="block text-xs font-black uppercase tracking-widest text-slate-400 mb-2 ml-1">Votre Identité</label>
            <div class="space-y-3">
                <input type="text" name="firstname" required placeholder="Prénom (ex: Ahmed)"
                ...
                <input type="text" name="lastname" required placeholder="Nom (ex: Benani)"
                       class="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-4 focus:ring-indigo-50 focus:border-indigo-600 outline-none transition-all font-medium">
            </div>
        </div>
