...
<div class="max-w-4xl w-full text-center">
    ...
    <div class="grid md:grid-cols-2 gap-8">
        <!-- Carte Étudiant -->
        <a href="register_student.php" class="group bg-white p-10 rounded-[3rem] border-2 border-transparent hover:border-indigo-600 shadow-xl shadow-slate-200/50 transition-all duration-300 transform hover:-translate-y-2">
        ...
        <!-- Carte Professeur -->
        <a href="register_formateur.php" class="group bg-white p-10 rounded-[3rem] border-2 border-transparent hover:border-slate-800 shadow-xl shadow-slate-200/50 transition-all duration-300 transform hover:-translate-y-2">
